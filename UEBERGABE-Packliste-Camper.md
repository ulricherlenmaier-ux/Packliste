...
- Tag-Dimensionen: Ort (Keller, EG, OG1, OG2, Auto/Camper), Kategorie inkl. **Workation** (Küche, Kleidung, Technik, Sport, MTB, Outdoor, Camping, Baden, Spiele, Dokumente, Orga, Essen, Workation), Reisetyp inkl. **Workation** (Camping, MTB-Trip, Badeurlaub, Winterurlaub, Städtetrip, Alpin, Workation, Immer). Plus separates Boolean-Feld `beiAbreise` (kein Tag-Array, einzelner Toggle im Bearbeiten-Modal unter "Zeitpunkt") – markiert Items, die erst kurz vor Abreise packbar sind (z.B. Handy, Kühlschrank-Essen); Filter-Chip "🧳 Schon packbar" blendet sie aus.
